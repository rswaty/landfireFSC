...
Open ArcGIS Pro and create a new project using a blank map template. Move the downloaded Ataya tutorial data into your project folder.

```{r GIS1, echo=FALSE, out.width=100}
...
```{r GIS2, echo=FALSE, out.width=100}
...
```{r GIS3, echo=FALSE, out.width=100}
...
```{r GIS4, echo=FALSE, out.width=100}
...
```{r GIS5, echo=FALSE, out.width=100}
...
```{r GIS6, echo=FALSE, out.width=100}
...
```{r GIS7, echo=FALSE, out.width=100}
...
```{r GIS8, echo=FALSE, out.width=100}
...
```{r GIS9, echo=FALSE, out.width=100}
...
```{r GIS10, echo=FALSE, out.width=100}
...
```{r GIS11, echo=FALSE, out.width=100}
...
```{r GIS12, echo=FALSE, out.width=100}
...
```{r GIS13, echo=FALSE, out.width=100}
...
```{r GIS14, echo=FALSE, out.width=100}
knitr::include_graphics("04_gis_screenshots/14_add_acres_field.png")

```

```{r GIS15, echo=FALSE, out.width=100}
...
```{r GIS16, echo=FALSE, out.width=100}
...
```{r GIS17, echo=FALSE, out.width=100}
...
```{r GIS18, echo=FALSE, out.width=100}
