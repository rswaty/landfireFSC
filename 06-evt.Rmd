...
We see that first there are many EVT's.  This partially due to the addition of Developed and other "modern" categories such as "Recently Logged-Tree Cover". Second we see that of the "natural" types there are some important changes from historical ecosystem conditions. In Ataya, there is currently far more acreage associated with Southern Appalachian Oak Forest and Alleghany Dry Oak Forest/Woodland. We can visually confirm this and other patterns with a quick chart made in R (similar charts available in Excel by highlighting the data, clicking Insert then selecting the chart type in the "Charts" tab):
