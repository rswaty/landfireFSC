...
# Introduction
The [Forest Stewardship Council](https://fsc.org/en) develops and delivers Principles, Criteria and Indicators for sustainable forest management (https://fsc.org/en/document-centre/documents/resource/392). Principles 6 and 9  are focused on Environmental Impact and Maintenance of High Conservation Value Areas respectfully.  Many of the criteria and indicators within Principles 6 and 9 require a GIS assessment of historical and current vegetation conditions, disturbance regimes, and landscape patterns.
