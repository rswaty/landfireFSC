...
2. You can turn off EVT layers and find different data layers on the left hand side. 
3. Regions and bookmarks can be found/made on the right. 

```{r LANDFIRE1, echo=FALSE, out.width=100}
...
2. This will allow you to ID layers you have selected. Your query will be displayed in the right hand-side. 
3. We see that we have clicked on "Southern and Central Appalachian Cove Forest" from our EVT layer.

```{r LANDFIRE2, echo=FALSE, out.width=100}
...
```{r LANDFIRE3, echo=FALSE, out.width=100}
...
```{r LANDFIRE4, echo=FALSE, out.width=100}
...
```{r LANDFIRE5, echo=FALSE, out.width=100}
...
```{r LANDFIRE6, echo=FALSE, out.width=100}
