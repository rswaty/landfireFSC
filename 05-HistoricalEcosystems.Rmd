...
In this section we will learn which ecosystems, and how much of each, were on our landscape historically.
...
We see that the top 4 BpSs comprised ~90% of our example landscape historically. We can visually confirm this and other patterns with a quick chart made in R (similar charts available in Excel by highlighting the data, clicking Insert then selecting the chart type in the "Charts" tab):
